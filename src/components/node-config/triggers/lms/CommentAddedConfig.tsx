...
const CommentAddedConfig: React.FC<ConfigComponentProps> = ({ config, setConfig }) => {
    ...
    return (
        <div className="space-y-4">
            <div>
                <h3 className="font-semibold text-gray-900">Comment Added</h3>
                <p className="text-sm text-gray-500">When a comment is added to selected courses, the workflow will trigger.</p>
            </div>
            ...
            {selectedCourses.length > 0 && (
                <div className="text-sm text-gray-600">
                    Automation will trigger when comments are added to any of these {selectedCourses.length} course{selectedCourses.length === 1 ? '' : 's'}
                </div>
            )}
...
export default CommentAddedConfig;
