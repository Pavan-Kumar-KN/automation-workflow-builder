...
const RemoveTagOperation: React.FC<ConfigComponentProps> = ({ config, setConfig }) => {
    ...
    return (
        <div className="space-y-4">
            {/* Header */}
            <div>
                <h3 className="font-semibold text-gray-900">Remove Tag</h3>
                <p className="text-sm text-gray-600 mt-1">
                    YRemove one or more tags to your contact.
                </p>
            </div>
...
export default RemoveTagOperation;