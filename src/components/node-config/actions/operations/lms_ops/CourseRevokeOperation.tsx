...
const CourseRevokeOperation: React.FC<ConfigComponentProps> = ({ config, setConfig }) => {
    ...
    return (
        <div className="space-y-4">
            {/* Header */}
            <div>
                <h3 className="font-semibold text-gray-900">Course Access Revoke</h3>
            </div>

            {/* Note */}
            <div className="bg-gray-50 p-3 rounded-lg">
                <p className="text-sm text-gray-700">
                    <strong>Note:</strong>It will revoke the course/bundle access
                </p>
            </div>
...
export default CourseRevokeOperation;